 ...
 * @license MIT
 */
sap.ui.define(["jquery.sap.global", "sap/ui/core/Control", "google.maps", "openui5/googlemaps/MapUtils", "./Animation"], function(t, e, i,
	n, o) {
	"use strict";
	...
	return s.prototype.init = function() {
		...
		this.marker || (this.marker = this.createMarker(), this.addListener(this.marker, "click", this.onClick.bind(this)), this.addListener(
				this.marker, "mouseover", this.onMouseover.bind(this)), this.addListener(this.marker, "mouseout", this.onMouseout.bind(this))), this
			.getDraggable() && this.addListener(this.marker, "dragend", this.onDragEnd.bind(this)), this.marker.setMap(this.map), this.marker.setOptions(
				this.getOptions()), "function" == typeof this.marker.setZIndex && this.marker.setZIndex(this.getZIndex()), this.infoWindow || (this.infoWindow =
				new i.InfoWindow({
		...
		var t = {};
		return t.position = new i.LatLng(this.getLat(), this.getLng()), t.draggable = this.getDraggable(), t.animation = this.getAnimation(),
			t.visible = this.getVisible(), t.icon = this.getIcon(), t.optimized = this.getOptimized(), t
